    ...
    <section className="flex h-screen w-screen flex-col items-center gap-15 p-10">
      <div className="relative flex h-[70%] w-full flex-col justify-between gap-10">
        <div className="flex flex-col text-7xl">
          ...
          <div className="text-center font-[AvenirRoman] text-6xl font-extrabold text-white/50 uppercase">
            Skills
          </div>
          <i className="bx bx-code-alt text-end text-orange-500/50"></i>
        </div>
        {/* Content */}
        <div className="grid grid-cols-2 gap-5 [&_label]:text-xl">
          <a
            href="https://react.dev/"
            target="_blank"
            className="flex h-15 w-full items-center justify-evenly rounded-xl bg-[#27163f]"
          >
        ...
        <div className="flex items-center gap-5">
          <div className="flex aspect-square w-10 items-center justify-center rounded-xl bg-[#27163f]">
            <i class="bx bx-wrench text-orange-500"></i>
          </div>
